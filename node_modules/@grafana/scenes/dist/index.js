...
function VizPanelRenderer({ model }) {
  ...
  const { series, annotations } = _UNSAFE_clearPreviousFieldValues ? (_a = rawData.data) != null ? _a : {} : {};
  ...
  if (dataWithFieldConfig.alertState) {
    titleItemsElement.push(
      /* @__PURE__ */ React__default.default.createElement(ui.Tooltip, { content: (_b = dataWithFieldConfig.alertState.state) != null ? _b : "unknown", key: `alert-states-icon-${model.state.key}` }, /* @__PURE__ */ React__default.default.createElement(
...
function AdHocFiltersRecommendationsRenderer({ model }) {
  ...
  const recentDrilldowns = recentFilters == null ? void 0 : recentFilters.map((filter) => ({
    ...
    onClick: () => {
      ...
      if (!exists) {
        ...
        runtime.reportInteraction("grafana_unified_drilldown_recent_filter_applied", {
          key: filter.key,
  ...
  const recommendedDrilldowns = recommendedFilters == null ? void 0 : recommendedFilters.map((filter) => ({
    ...
    onClick: () => {
      ...
      if (!exists) {
        model.addFilterToParent(filter);
        runtime.reportInteraction("grafana_unified_drilldown_recommended_filter_applied", {
          key: filter.key,
          operator: filter.operator
        });
      }
...
function AdHocGroupByRecommendationsRenderer({ model }) {
  ...
  const recentDrilldowns = recentGrouping == null ? void 0 : recentGrouping.map((groupBy) => ({
    ...
    onClick: () => {
      ...
      runtime.reportInteraction("grafana_unified_drilldown_recent_groupby_applied", {
  ...
  const recommendedDrilldowns = recommendedGrouping == null ? void 0 : recommendedGrouping.map((groupBy) => ({
    ...
    onClick: () => {
      model.addGroupByToParent(String(groupBy.value));
      runtime.reportInteraction("grafana_unified_drilldown_recommended_groupby_applied", {
        key: String(groupBy.value)
      });
    }
  }));
...
class AdHocFiltersVariable extends SceneObjectBase {
  ...
  _addGroupByFilter(item) {
    ...
    runtime.reportInteraction("grafana_unified_drilldown_groupby_added", { key });
  }
  restoreOriginalFilter(filter) {
    var _a;
    ...
    runtime.reportInteraction("grafana_unified_drilldown_filter_restored", {
      key: filter.key,
      origin: filter.origin
    });
  }
  ...
  restoreOriginalGroupBy() {
    ...
    runtime.reportInteraction("grafana_unified_drilldown_groupby_restored");
  }
  /**
  ...
  clearAll() {
    ...
    runtime.reportInteraction("grafana_unified_drilldown_clear_all", {
  ...
  _updateFilter(filter, update) {
    ...
    if (filter === _wip) {
      if ("value" in update && update["value"] !== "") {
        ...
        runtime.reportInteraction("grafana_unified_drilldown_filter_added", {
          key: newFilter.key,
  ...
  updateToMatchAll(filter) {
    ...
    if (isGroupByFilter(filter) && filter.origin) {
      ...
      runtime.reportInteraction("grafana_unified_drilldown_groupby_removed", {
        key: filter.key,
        origin: filter.origin
      });
    } else {
      ...
      runtime.reportInteraction("grafana_unified_drilldown_filter_match_all", {
        key: filter.key,
        origin: filter.origin
      });
    }
...
function __variableDynamicImportRuntime0__(path) {
  switch (path) {
    ...
    case '../locales/en-US/grafana-scenes.json': return Promise.resolve().then(function () { return require('./grafana-scenes-CbEwg8-p.js'); });
