...
import React, { useMemo, useCallback, useLayoutEffect, useEffect, memo, useRef } from 'react';
import { useMeasure, usePrevious } from 'react-use';
import { SetPanelAttentionEvent, AlertState, PluginContextProvider, PanelPlugin, PluginType } from '@grafana/data';
...
function VizPanelRenderer({ model }) {
  ...
  if (dataWithFieldConfig.alertState) {
    titleItemsElement.push(
      /* @__PURE__ */ React.createElement(Tooltip, { content: (_c = dataWithFieldConfig.alertState.state) != null ? _c : "unknown", key: `alert-states-icon-${model.state.key}` }, /* @__PURE__ */ React.createElement(
...
export { VizPanelRenderer, getLoadingPlugin };
