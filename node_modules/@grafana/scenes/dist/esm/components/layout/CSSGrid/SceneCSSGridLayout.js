...
function SceneCSSGridLayoutRenderer({ model }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: style }, children.map((item) => {
    ...
    if (isLazy) {
      return /* @__PURE__ */ React.createElement(LazyLoader, { key: item.state.key, className: style, mode: "query" }, /* @__PURE__ */ React.createElement(Component, { key: item.state.key, model: item, parentState: model.state }));
    }
