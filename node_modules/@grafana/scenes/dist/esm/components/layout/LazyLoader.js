...
const LazyLoader = React.forwardRef(
  ({ children, onLoad, onChange, className, mode = "mount", ...rest }, ref) => {
    ...
    return /* @__PURE__ */ React.createElement("div", { id, ref: innerRef, className: `${hideEmpty} ${className}`, ...rest }, !loaded && mode === "mount" ? (
      // eslint-disable-next-line @grafana/i18n/no-untranslated-strings
      "\xA0"
    ) : /* @__PURE__ */ React.createElement(LazyLoaderInViewContext.Provider, { value: isInView }, children));
  }
);
function getStyles() {
  return {
