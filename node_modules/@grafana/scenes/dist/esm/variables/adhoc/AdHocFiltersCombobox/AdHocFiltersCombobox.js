...
import { isMultiValueOperator, OPERATORS } from '../AdHocFiltersVariable.js';
import { useVirtualizer } from '@tanstack/react-virtual';
import { LoadingOptionsPlaceholder, OptionsErrorPlaceholder, ExpressionHintPlaceholder, NoOptionsPlaceholder, DropdownItem, MultiValueApplyButton } from './DropdownItem.js';
import { flattenOptionGroups, setupDropdownAccessibility, VIRTUAL_LIST_OVERSCAN, VIRTUAL_LIST_ITEM_HEIGHT_WITH_DESCRIPTION, VIRTUAL_LIST_ITEM_HEIGHT, switchInputType, generateFilterUpdatePayload, populateInputValueOnInputTypeSwitch, switchToNextInputType, generatePlaceholder, ERROR_STATE_DROPDOWN_WIDTH } from './utils.js';
import { handleOptionGroups } from '../../utils.js';
import { useFloatingInteractions, MAX_MENU_HEIGHT } from './useFloatingInteractions.js';
import { useFreeFormExpression } from './useFreeFormExpression.js';
import { MultiValuePill } from './MultiValuePill.js';
import { getAdhocOptionSearcher } from '../getAdhocOptionSearcher.js';
import { FILTER_CHANGED_INTERACTION, ADHOC_KEYS_DROPDOWN_INTERACTION, ADHOC_VALUES_DROPDOWN_INTERACTION } from '../../../performance/interactionConstants.js';
...
const AdHocCombobox = forwardRef(function AdHocCombobox2({
  ...
  const [filterInputType, setInputType] = useState(initialInputType);
  const [preventFiltering, setPreventFiltering] = useState(initialInputType === "value");
  ...
  const filterInputTypeRef = useRef(initialInputType);
  ...
  const getFirstSelectableIndex = useCallback((items) => {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: styles.comboboxWrapper }, filter && !isGroupBy ? /* @__PURE__ */ React.createElement("div", { className: styles.pillWrapper }, (filter == null ? void 0 : filter.key) ? /* @__PURE__ */ React.createElement("div", { className: cx(styles.basePill, styles.keyPill) }, keyLabel) : null, (filter == null ? void 0 : filter.key) && (filter == null ? void 0 : filter.operator) && filterInputType !== "operator" ? /* @__PURE__ */ React.createElement(
    "div",
    {
