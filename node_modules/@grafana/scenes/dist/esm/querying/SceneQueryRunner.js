...
import { preProcessPanelData, compareArrayValues, DataTopic, DataFrameView, rangeUtil } from '@grafana/data';
...
function getNextRequestId(prefix = "SQR") {
...
class SceneQueryRunner extends SceneObjectBase {
  constructor(initialState) {
    ...
    this.onDataReceived = (data) => {
      ...
      if (last != null && dataWithLayersApplied.state !== LoadingState.Streaming) {
        const sameSeries = compareArrayValues((_a = last.series) != null ? _a : [], (_b = dataWithLayersApplied.series) != null ? _b : [], (a, b) => a === b);
        ...
        const sameErrors = compareArrayValues(
  ...
  cancelQuery() {
    ...
    this.setState({
      data: { ...(_b = this.state.data) != null ? _b : emptyPanelData, state: LoadingState.Done }
    });
  }
