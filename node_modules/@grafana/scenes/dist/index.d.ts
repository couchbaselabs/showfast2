...
import { Options as Options$2 } from '@grafana/schema/dist/esm/raw/composable/gauge/panelcfg/x/GaugePanelCfg_types.gen';
import { Options as Options$3 } from '@grafana/schema/dist/esm/raw/composable/geomap/panelcfg/x/GeomapPanelCfg_types.gen';
import { Options as Options$4, FieldConfig as FieldConfig$2 } from '@grafana/schema/dist/esm/raw/composable/heatmap/panelcfg/x/HeatmapPanelCfg_types.gen';
import { Options as Options$5, FieldConfig as FieldConfig$3 } from '@grafana/schema/dist/esm/raw/composable/histogram/panelcfg/x/HistogramPanelCfg_types.gen';
import { Options as Options$6 } from '@grafana/schema/dist/esm/raw/composable/logs/panelcfg/x/LogsPanelCfg_types.gen';
import { Options as Options$7 } from '@grafana/schema/dist/esm/raw/composable/news/panelcfg/x/NewsPanelCfg_types.gen';
import { Options as Options$8 } from '@grafana/schema/dist/esm/raw/composable/nodegraph/panelcfg/x/NodeGraphPanelCfg_types.gen';
import { Options as Options$9, FieldConfig as FieldConfig$4 } from '@grafana/schema/dist/esm/raw/composable/piechart/panelcfg/x/PieChartPanelCfg_types.gen';
import { Options as Options$a } from '@grafana/schema/dist/esm/raw/composable/stat/panelcfg/x/StatPanelCfg_types.gen';
import { Options as Options$b, FieldConfig as FieldConfig$5 } from '@grafana/schema/dist/esm/raw/composable/statetimeline/panelcfg/x/StateTimelinePanelCfg_types.gen';
import { Options as Options$c, FieldConfig as FieldConfig$6 } from '@grafana/schema/dist/esm/raw/composable/statushistory/panelcfg/x/StatusHistoryPanelCfg_types.gen';
import { Options as Options$d } from '@grafana/schema/dist/esm/raw/composable/table/panelcfg/x/TablePanelCfg_types.gen';
import { Options as Options$e } from '@grafana/schema/dist/esm/raw/composable/text/panelcfg/x/TextPanelCfg_types.gen';
import { Options as Options$f, FieldConfig as FieldConfig$7 } from '@grafana/schema/dist/esm/raw/composable/timeseries/panelcfg/x/TimeSeriesPanelCfg_types.gen';
import { Options as Options$g, FieldConfig as FieldConfig$8 } from '@grafana/schema/dist/esm/raw/composable/trend/panelcfg/x/TrendPanelCfg_types.gen';
import { Options as Options$h } from '@grafana/schema/dist/esm/raw/composable/xychart/panelcfg/x/XYChartPanelCfg_types.gen';
import { ResourceLoader } from '@grafana/i18n';

interface DataSourceControlRef {
    type: 'datasource';
    group: string;
}
type ControlSourceRef = DataSourceControlRef;
...
declare abstract class SceneObjectBase<TState extends SceneObjectState = SceneObjectState> implements SceneObject<TState> {
    static RENDER_BEFORE_ACTIVATION_DEFAULT: boolean;
    private _isActive;
    private _state;
...
declare class AdHocFiltersRecommendations extends SceneObjectBase<AdHocFiltersRecommendationsState> {
    ...
    private get _isGroupByEnabled();
    private _activationHandler;
    private _reloadStoredFilters;
    private _reloadStoredGroupings;
    private _getFiltersStorageKey;
    private _getGroupingStorageKey;
     ...
     */
    storeRecentGrouping(groupByKey: string): void;
    addFilterToParent(filter: AdHocFilterWithLabels): void;
    addGroupByToParent(key: string): void;
}
...
type getGroupByKeysProvider = (variable: AdHocFiltersVariable, currentKey?: string | null) => Promise<{
    replace?: boolean;
    values: GetTagResponse | MetricFindValue[];
}>;
...
declare const OPERATORS: OperatorDefinition[];
declare class AdHocFiltersVariable extends SceneObjectBase<AdHocFiltersVariableState> implements SceneVariable<AdHocFiltersVariableState> {
    ...
    validateOriginFilters(filters: AdHocFilterWithLabels[]): AdHocFilterWithLabels[];
    /**
     ...
     */
    _addGroupByFilter(item: SelectableValue<string>): void;
     ...
     */
    getOriginalValue(filter: AdHocFilterWithLabels): {
        value: string[];
        operator: string;
        valueLabels?: string[];
        keyLabel?: string;
    ...
    getFiltersApplicabilityForQueries(filters: AdHocFilterWithLabels[], queries: SceneDataQuery[], groupByKeys?: string[]): Promise<DrilldownsApplicability[] | undefined>;
     ...
     */
    _getGroupByKeys(currentKey: string | null, queries?: SceneDataQuery[]): Promise<Array<SelectableValue<string>>>;
    /**
...
declare const GROUP_BY_OPERATOR = "groupBy";
declare function isGroupByFilter(filter: AdHocFilterWithLabels): boolean;
...
declare class GroupByVariable extends MultiValueVariable<GroupByVariableState> {
     ...
     *   instead of discovering all queries in the scene via getQueriesForVariables.
     */
    _getKeys: (ds: DataSourceApi, queries?: SceneDataQuery[]) => Promise<GetTagResponse | MetricFindValue[]>;
...
declare function getClosest<T>(sceneObject: SceneObject, extract: (s: SceneObject) => T | undefined): T | undefined;
...
interface AdHocFilterInteractionHandler {
    isAdHocFilterInteractionHandler: true;
    onFilterAdded?(payload: {
        key: string;
        operator: string;
    }): void;
    ...
    onFilterMatchAll?(payload: {
        key: string;
        origin?: string;
    }): void;
    onFilterRestored?(payload: {
        key: string;
        origin?: string;
    }): void;
    onGroupByAdded?(payload: {
        key: string;
    }): void;
    onGroupByRemoved?(payload: {
        key: string;
        origin?: string;
    }): void;
    ...
    onClearAll?(payload: {
        ...
        originsRestored: number;
    }): void;
    onRecentFilterApplied?(payload: {
        key: string;
        operator: string;
    }): void;
    onRecommendedFilterApplied?(payload: {
        key: string;
        operator: string;
    }): void;
    onRecentGroupByApplied?(payload: {
        key: string;
    }): void;
    onRecommendedGroupByApplied?(payload: {
        key: string;
    }): void;
}
...
declare const GRID_CELL_HEIGHT = 30;
declare const GRID_COLUMN_COUNT = 24;
 ...
 * query = children is always rendered. Only sets the LazyLoaderInViewContext which is used to block query execution for panels out of view
 */
type LazyLoaderMode = 'mount' | 'query';
...
declare const PanelOptionsBuilders: {
    ...
    gauge(): PanelOptionsBuilder<Options$2>;
    geomap(): PanelOptionsBuilder<Options$3>;
    heatmap(): PanelOptionsBuilder<Options$4>;
    histogram(): PanelOptionsBuilder<Options$5>;
    logs(): PanelOptionsBuilder<Options$6>;
    news(): PanelOptionsBuilder<Options$7>;
    nodegraph(): PanelOptionsBuilder<Options$8>;
    piechart(): PanelOptionsBuilder<Options$9>;
    stat(): PanelOptionsBuilder<Options$a>;
    statetimeline(): PanelOptionsBuilder<Options$b>;
    statushistory(): PanelOptionsBuilder<Options$c>;
    table(): PanelOptionsBuilder<Options$d>;
    text(): PanelOptionsBuilder<Options$e>;
    timeseries(): PanelOptionsBuilder<Options$f>;
    trend(): PanelOptionsBuilder<{}>;
    traces(): PanelOptionsBuilder<Options$g>;
    xychart(): PanelOptionsBuilder<Options$h>;
};
...
declare class FieldConfigBuilder<TFieldConfig extends {}> implements StandardFieldConfigInterface<StandardFieldConfig, FieldConfigBuilder<TFieldConfig>, 'set'> {
    ...
    build(): {
        ...
        overrides: {
            matcher: _grafana_schema.MatcherConfig;
            properties: Array<{
                id: string;
                value: unknown;
            }>;
...
declare const PanelBuilders: {
    ...
    gauge(): VizPanelBuilder<Options$2, {}>;
    geomap(): VizPanelBuilder<Options$3, {}>;
    heatmap(): VizPanelBuilder<Options$4, FieldConfig$2>;
    histogram(): VizPanelBuilder<Options$5, FieldConfig$3>;
    logs(): VizPanelBuilder<Options$6, {}>;
    news(): VizPanelBuilder<Options$7, {}>;
    nodegraph(): VizPanelBuilder<Options$8, {}>;
    piechart(): VizPanelBuilder<Options$9, FieldConfig$4>;
    stat(): VizPanelBuilder<Options$a, {}>;
    statetimeline(): VizPanelBuilder<Options$b, FieldConfig$5>;
    statushistory(): VizPanelBuilder<Options$c, FieldConfig$6>;
    table(): VizPanelBuilder<Options$d, TableFieldOptions>;
    text(): VizPanelBuilder<Options$e, {}>;
    timeseries(): VizPanelBuilder<Options$f, FieldConfig$7>;
    trend(): VizPanelBuilder<{}, {}>;
    traces(): VizPanelBuilder<Options$g, FieldConfig$8>;
    xychart(): VizPanelBuilder<Options$h, {}>;
};
...
declare const VizConfigBuilders: {
    ...
    gauge(): VizConfigBuilder<Options$2, {}>;
    geomap(): VizConfigBuilder<Options$3, {}>;
    heatmap(): VizConfigBuilder<Options$4, FieldConfig$2>;
    histogram(): VizConfigBuilder<Options$5, FieldConfig$3>;
    logs(): VizConfigBuilder<Options$6, {}>;
    news(): VizConfigBuilder<Options$7, {}>;
    nodegraph(): VizConfigBuilder<Options$8, {}>;
    piechart(): VizConfigBuilder<Options$9, FieldConfig$4>;
    stat(): VizConfigBuilder<Options$a, {}>;
    statetimeline(): VizConfigBuilder<Options$b, FieldConfig$5>;
    statushistory(): VizConfigBuilder<Options$c, FieldConfig$6>;
    table(): VizConfigBuilder<Options$d, TableFieldOptions>;
    text(): VizConfigBuilder<Options$e, {}>;
    timeseries(): VizConfigBuilder<Options$f, FieldConfig$7>;
    trend(): VizConfigBuilder<{}, {}>;
    traces(): VizConfigBuilder<Options$g, FieldConfig$8>;
    xychart(): VizConfigBuilder<Options$h, {}>;
};
