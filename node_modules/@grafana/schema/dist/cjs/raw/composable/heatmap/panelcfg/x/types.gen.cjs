...
var index = require('../../../../../index-DlQGjEAS.js');
...
const defaultOptions = {
  ...
  selectionMode: "x" /* X */,
  showValue: index.VisibilityMode.Auto,
  tooltip: {
    mode: index.TooltipDisplayMode.Single,
    yHistogram: false,
    showColorScale: false
  }
};

exports.HeatmapColorMode = HeatmapColorMode;
exports.HeatmapColorScale = HeatmapColorScale;
exports.HeatmapSelectionMode = HeatmapSelectionMode;
