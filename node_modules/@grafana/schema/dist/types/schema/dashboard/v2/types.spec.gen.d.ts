...
export declare const defaultAnnotationEventFieldMapping: () => AnnotationEventFieldMapping;
...
export declare const defaultTransformationSpec: () => TransformationSpec;
...
export declare const defaultMatcherScope: () => MatcherScope;
...
export declare const defaultNullValueMode: () => NullValueMode;
...
export declare const defaultVariableRegexApplyTo: () => VariableRegexApplyTo;
...
export declare const defaultControlSourceRef: () => ControlSourceRef;
export interface DatasourceControlSourceRef {
    type: "datasource";
    group: string;
}
export declare const defaultDatasourceControlSourceRef: () => DatasourceControlSourceRef;
